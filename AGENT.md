# **Allegato Settimana 2 — da copiare nella root di ogni repository.** Questo file è il system prompt del vostro progetto: l'agente lo legge prima di qualsiasi altra azione.
